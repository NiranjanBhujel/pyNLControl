 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Feb 15 07:56:44 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lqr_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES           "__SFB__lqr_code.c__SFB__lqr_code_Call.c"
#define PANELINDEX            8
...
extern void lqr_sfun_Outputs_wrapper(const real_T *x,
			const real_T *ref,
			const real_T *Q,
			const real_T *R,
			real_T *u,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *ref = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *Q = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *R = (real_T *) ssGetInputPortRealSignal(S, 3);
    real_T *u = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *K = (real_T *) ssGetOutputPortRealSignal(S, 1);

    lqr_sfun_Outputs_wrapper(x, ref, Q, R, u, K);

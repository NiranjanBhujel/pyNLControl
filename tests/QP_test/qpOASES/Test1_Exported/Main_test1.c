...
int main(int argc, char const *argv[])
{
    ...
    double *xGuess = (double *)malloc(2 * sizeof(double));
    double *a = (double *)malloc(1 * sizeof(double));
    double *b = (double *)malloc(1 * sizeof(double));

    
    double *xOpt_VAL = (double *)malloc(2 * sizeof(double));
    double *Obj_VAL = (double *)malloc(1 * sizeof(double));
    ...
    for (i=0; i<2; i++)
        fprintf(ptr, "xOpt_VAL_%d,", i+1);
    
    for (i=0; i<1; i++)
        fprintf(ptr, "Obj_VAL_%d,", i+1);
    ...
    {   
        ...
        for (i = 0; i < 2; i++)
            xGuess[i] = DataIn[k*COL+0+i+1];
             
        
        for (i = 0; i < 1; i++)
            a[i] = DataIn[k*COL+2+i+1];
             
        
        for (i = 0; i < 1; i++)
            b[i] = DataIn[k*COL+3+i+1];
        ...
        for (i = 0; i < 2; i++)
            fprintf(ptr, "%f,", xOpt_VAL[i]);
        
        for (i = 0; i < 1; i++)
            fprintf(ptr, "%f,", Obj_VAL[i]);
